...
set "START_SCRIPT=start-lan.cmd"
if exist "start-lan-private.cmd" set "START_SCRIPT=start-lan-private.cmd"

echo Starting Imaginary Local Media AI for LAN access...
start "Imaginary Local Media AI LAN" cmd /k call "%~dp0%START_SCRIPT%"
...
if errorlevel 1 (
  ...
  echo Browser opened on this PC. You can also open the LAN address on your Android device once the server window shows it.
)
endlocal

...
TASK_MODEL_SPECS: dict[TaskType, list[ModelSpec]] = {
    ...
    "text_to_video": [
        ...
        ModelSpec(
            ...
            target_height=720,
            render_strategy="native",
            notes="Higher-quality text-to-video option for bigger GPUs.",
        ),
        ModelSpec(
            key="wan-t2v-14b-1080p",
            label="Wan2.1 T2V 14B 1080P via Upscaling",
            repo_id="Wan-AI/Wan2.1-T2V-14B-Diffusers",
            pipeline_class="WanPipeline",
            family="video",
            license_name="Apache-2.0",
            ...
            notes="Uses native 720P generation and then upscales to 1080P for an HD delivery profile.",
        ),
    ],
    "image_to_video": [
        ModelSpec(
            ...
            target_height=480,
            render_strategy="native",
            notes="Best open local image-to-video option in this stack, but substantially heavier.",
        ),
        ModelSpec(
            ...
            target_height=720,
            render_strategy="native",
            notes="Native 720P image-to-video option with significantly higher memory demand.",
        ),
        ModelSpec(
            key="wan-i2v-14b-1080p",
            label="Wan2.1 I2V 14B 1080P via Upscaling",
            repo_id="Wan-AI/Wan2.1-I2V-14B-720P-Diffusers",
            pipeline_class="WanImageToVideoPipeline",
            family="video",
            license_name="Apache-2.0",
            ...
            target_height=1080,
            render_strategy="upscale",
            notes="Uses native 720P generation and then upscales to 1080P for HD export.",
        ),
    ],
}
